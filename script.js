    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ללמוד אנגלית תוך 10 דקות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '150f933c-9409-432b-80b2-1bbfa04fb27e',
                    name: data.name || '',
                    email: data.email || '',
